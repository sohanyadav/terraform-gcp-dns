...
module "dns_forwarding_zone" {
  source                             = "https://github.com/sohanyadav/terraform-gcp-dns.git"
  type                               = "forwarding"
  name                               = "app-test"
...
# Examples
For detailed examples on how to use this module, please refer to the [example](https://github.com/sohanyadav/terraform-gcp-dns/tree/master/_example) directory within this repository.
...
## License
This project is licensed under the MIT License - see the [LICENSE](https://github.com/sohanyadav/terraform-gcp-dns/blob/master/LICENSE) file for details.
...
| <a name="input_description"></a> [description](#input\_description) | zone description (shown in console) | `string` | `"Managed by sohanyadav"` | no |
